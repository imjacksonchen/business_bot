...
# recipient_title = input("What is the recipient's title")
# recipient_company = input("What is the recipient's company")

# sender_name = input("What is the sender's name")
# sender_company = input("What is the sender's company")